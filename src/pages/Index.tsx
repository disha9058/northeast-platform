...
const Index = () => {
  const [currentRole, setCurrentRole] = useState<UserRole>("dho");
  
  const currentUser = {
    name: currentRole === "community" ? "Rahul Sharma" : 
          currentRole === "asha" ? "Priya Devi" :
          currentRole === "dho" ? "Dr. Amit Borah" : "Sarah Johnson",
    role: currentRole
  };
      ...
      <section className="border-b bg-muted/30">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            <span className="text-sm font-medium text-muted-foreground">Demo Mode - Switch Role:</span>
            <div className="flex gap-2">
              {(["community", "asha", "dho", "authority"] as const).map((role) => (
                <Button
                  key={role}
                ...
                >
                  {role === "asha" ? "ASHA Worker" : role === "dho" ? "DHO" : role}
                </Button>
              ))}
            </div>
          </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      ...
                      <div className="p-4 border rounded-lg">
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button size="sm" variant="outline">Mizo</Button>
                        </div>
                      </div>
                    </div>
                  </CardContent>
